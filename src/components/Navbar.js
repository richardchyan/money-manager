   ...
   return (
      <div className="bg-green-600">
         <nav className="flex flex-col md:flex-row py-6 px-4 justify-between max-w-screen-lg m-auto items-center">
            <Link to="/">
               <h1 className="font-bold text-white text-2xl md:text-5xl">Money Manager</h1>
            </Link>
            <div className="flex flex-col md:flex-row items-center space-x-8">
               {!user && (
                  <>
                     <Link to="/login">
                        <h2 className="text-xl text-black rounded-lg py-2 px-4 bg-white">Login</h2>
                     </Link>
                     <Link to="/signup">
                        <h2 className="text-xl text-black rounded-lg py-2 px-4 bg-white">Sign up</h2>
                     </Link>
                  </>
